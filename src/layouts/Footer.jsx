  ...
  return (
    <>
      ...
      <div>
        ...
        <ul>
          {
            socialLinks.map(({ id, name, icon, link }) => (
              <a href={link} key={id} className="">
                <li className="bg-[#050512] text-center flex flex-col">
              {id === 1 && (<br />)}
                <img src={icon} alt={name} className='h-[40px] sm:h-[45px]
                md:h-[50px] lg:h-[55px] xl:h-[60px] 2xl:h-[70px]'/>
        ...
        <a onClick={capyEmail} className="block text-2xl md:text-3xl lg:text-4xl text-center font-black text-[#cfdaff] bg-[#000]">
        <br />
        company@
